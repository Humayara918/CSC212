// PROVIDED BY: ___Humayara Karim hkarim000@citymail.cuny.edu_____________ (your name and email address)
// FILE: sequence3.h
...
namespace main_savitch_5
{
    ...
    private:
        ...
        node *m_tail; //last item
        size_type m_total_n; // total nodes
        node *m_current_n; //current item in the sequence 
        node* m_prev_n; //previous item 
    };
}
